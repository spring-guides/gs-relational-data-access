...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/relationaldataaccess/Customer.kt[]
----
====
...
All you have to do is focus on the task at hand. The following listing shows
a class that can store and retrieve data over JDBC:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/relationaldataaccess/RelationalDataAccessApplication.kt[]
----
====
...
Second, take a list of strings and split them into firstname/lastname pairs using streams in Java
or collection functions in Kotlin.
...
NOTE: Lambdas map nicely onto single method interfaces, such as Spring's `RowMapper` (Java lambdas or Kotlin function literals with receivers).
